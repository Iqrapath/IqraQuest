...
{
    /**
     * Display the student's profile settings page.
     */
    public function index()
    {
        $user = Auth::user()->load('student.subjects');
    ...
    public function update(Request $request)
    {
        ...
        // Update Student table fields (Partial Update)
        // We filter out user fields and 'subjects' which is handled separately
        $studentData = array_diff_key($validated, array_flip(['name', 'phone', 'subjects']));
