...
class VerificationCallScheduledNotification extends Notification implements ShouldQueue, ShouldBroadcast
{
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        $scheduledDate = Carbon::parse($this->scheduledAt)->format('M d, Y \a\t h:i A') . ' UTC';
    ...
    public function toArray(object $notifiable): array
    {
        return [
            ...
            'message' => 'Your verification call is scheduled for ' . Carbon::parse($this->scheduledAt)->format('M d, Y h:i A') . ' UTC',
