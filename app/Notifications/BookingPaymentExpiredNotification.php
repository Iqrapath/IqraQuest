...
class BookingPaymentExpiredNotification extends Notification implements ShouldQueue
{
    ...
    public function toMail(object $notifiable): MailMessage
    {
        return (new MailMessage)
            ...
            ->line("Your reservation for the session with {$this->booking->teacher->user->name} on {$this->booking->start_time->format('M j, Y \a\t g:i A')} UTC has expired due to non-payment.")
