...
import ProgressCard from '@/pages/Student/components/ProgressCard';
...
export default function ProgressIndex({ student, stats }: Props) {
    return (
            ...
            <div className="max-w-[1000px] flex flex-col gap-8">
                ...
                <div className="flex flex-col gap-2">
                    ...
                    <p className="text-gray-500 text-[18px] max-w-[700px] leading-relaxed">
                        Track your Quran learning journey — attendance, memorization, and teacher feedback all in one glance.
                    </p>
                </div>
                ...
                <div className="flex flex-col gap-6">
                    <div className="flex flex-col gap-1">
                        ...
                        <p className="text-gray-400 text-[15px]">Latest Feedback:</p>
                    </div>
...
ProgressIndex.layout = (page: React.ReactNode) => <StudentLayout children={page} />;
