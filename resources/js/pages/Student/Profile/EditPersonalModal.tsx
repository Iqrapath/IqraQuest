...
export default function EditPersonalModal({ open, onOpenChange, user, student }: Props) {
                ...
                <div className="p-6 md:p-8">
                    <DialogHeader className="mb-6 text-left">
                        <div className="flex justify-between items-center">
                            ...
                            {/* Close button is handled by DialogContent default in shadcn but Figma shows custom X? Shadcn creates one top-right. */}
                        </div>
                    </DialogHeader>
                    ...
                    <form onSubmit={handleSubmit} className="flex flex-col gap-6">
                        ...
                        <div className="flex flex-col gap-2">
                            ...
                            <div className="bg-[#f4f4f6] rounded-[10px] flex items-center px-4 py-3">
                                ...
                                <input
                                    ...
                                    value={user.email}
                                    disabled
                                    placeholder="Enter your Delivery Address" // Placeholder from design
                        ...
                        <div className="flex flex-col gap-2">
                            ...
                            <div className="bg-[#f4f4f6] rounded-[10px] flex items-center px-4 py-3 border border-transparent focus-within:border-[#338078] transition-colors">
                                ...
                                <input
                                    type="text"
                                    value={data.city} // Simplified: Using text input instead of complex select for now as we don't have geo-db yet or just combine city/country
