...
export const EditBankDetailsModal: React.FC<EditBankDetailsModalProps> = ({
    ...
    const verifyAccount = async () => {
        ...
        try {
            const response = await fetch(`/student/payment/resolve-account?account_number=${accountNumber}&bank_code=${selectedBank}`);
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            const response = await fetch(`/student/payment/methods/bank/${bankDetails.id}`, {
                method: 'PUT',
                headers: {
