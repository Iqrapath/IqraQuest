    ...
    return (
        <div className="flex flex-col gap-0 -mt-0">
            ...
            <div className="w-full">
                <HeroBanner
                    name={student.name}
                    subtitle="Continue your Quran learning journey — view your upcoming classes, track progress, and connect with teachers."
                />
            </div>
            ...
            <div className="container mx-auto px-6 -mt-25 relative z-20 pb-12">
                ...
                <StudentStatsCard
                    stats={statsItems}
                    headerAction={
                        <Link href="/student/teachers" className="text-[#338078] font-bold text-sm hover:underline transition-all">Browse Teachers</Link>
                    }
                />
                ...
                <div className="mt-10 flex flex-col gap-10">
                    ...
                    <div className="bg-white border border-[#e5e7eb] rounded-[clamp(1.5rem,3vw,2rem)] overflow-hidden shadow-sm">
                        <div className="px-[clamp(1.5rem,3vw,2rem)] py-[clamp(1rem,2vw,1.5rem)] border-b border-[#e5e7eb] flex justify-between items-center bg-gray-50/50">
                            ...
                            <Link href="/student/bookings?status=upcoming" className="text-[#338078] font-bold text-sm hover:underline">
                                View All
                            </Link>
                        </div>
