    ...
    return (
        <StudentLayout>
            ...
            <div className="flex flex-col gap-6 p-4 md:p-6 max-w-[800px] mx-auto w-full">
                ...
                {/* Header with Back Button (Image 4) */}
                <div className="flex items-center gap-4">
                    <Link href="/student/ratings" className="p-2 hover:bg-gray-100 rounded-full transition-all flex-shrink-0">
                ...
                <div className="flex flex-col gap-5 mt-2">
                    {reviews.length > 0 ? reviews.map(review => (
                        ...
                        <p className="text-center text-gray-400 py-12 font-['Nunito'] italic bg-white border border-dashed rounded-[24px]">No reviews found.</p>
                    )}
                </div>
            </div>
        </StudentLayout>
