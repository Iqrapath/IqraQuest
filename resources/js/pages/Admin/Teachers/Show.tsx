...
interface Teacher {
    ...
    // Add optional properties for rating if they exist in backend, otherwise handle in component
    rating?: number;
    review_count?: number;
}
    ...
    return (
        <>
            ...
            <div className="w-full">
                ...
                {/* Rest of the profile content will go here */}
            </div>
        </>
    );
}

TeacherShow.layout = (page: React.ReactNode) => <AdminLayout children={page} hideRightSidebar={true} />;
