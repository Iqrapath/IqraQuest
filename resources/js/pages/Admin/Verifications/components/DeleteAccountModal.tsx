...
import { router } from '@inertiajs/react'; // Ensure correct import for router
...
export default function DeleteAccountModal({ isOpen, onClose, teacherId }: DeleteAccountModalProps) {
    const handleDelete = () => {
        router.delete(`/admin/verifications/${teacherId}`, {
            onSuccess: () => {
                onClose();
            },
        });
