                ...
                {!isLoading && pagination.lastPage > 1 && (
                    <div className="mt-8 w-full clear-both flex items-center justify-center gap-2">
                        <button
                            ...
                            className="rounded-md border border-gray-300 px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 disabled:cursor-not-allowed disabled:opacity-50 cursor-pointer"
                        >
                            Previous
                        </button>
...
Browse.layout = (page: React.ReactNode) => <GuardianLayout children={page} hideRightSidebar={true} />;
