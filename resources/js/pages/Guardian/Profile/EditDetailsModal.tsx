...
export default function EditDetailsModal({ open, onOpenChange, guardian }: Props) {
    // Helper to parse existing preferred_days JSON or create default structure
    const getInitialSchedule = (): DaySchedule[] => {
        const stored = guardian.preferred_days;
    ...
    const { data, setData, post, processing, transform } = useForm({
        timezone: guardian.timezone || 'Africa/Lagos',
        availability_type: guardian.availability_type || 'Part-Time',
