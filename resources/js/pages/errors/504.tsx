                ...
                <div className="max-w-4xl w-full">
                    <div className="grid md:grid-cols-2 gap-8 items-center">
                        ...
                        <div className="order-2 md:order-1">
                            <img 
                                src="/images/errors/504-Error-Gateway-Timeout.svg"
                                alt="Gateway Timeout Illustration"
                        ...
                        <div className="order-1 md:order-2 text-center md:text-left">
                            <h1 className="font-['Poppins'] text-[120px] font-bold text-[#F5AD7E] leading-none mb-4">504</h1>
                            <h2 className="font-['Poppins'] text-[32px] md:text-[40px] font-semibold text-[#1C2A3A] mb-4">Gateway Timeout</h2>
                            <p className="font-['Nunito'] text-[18px] text-[#6B7280] mb-8">
                                The server took too long to respond. This might be a temporary issue. Please try again.
                            </p>
