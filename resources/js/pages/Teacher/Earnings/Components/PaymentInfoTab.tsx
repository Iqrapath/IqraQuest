...
export default function PaymentInfoTab({ onAddPaymentInfo, paymentMethods = [], onEditMethod }: PaymentInfoTabProps) {
                        ...
                        <div className="flex-1 space-y-3 w-full">
                            <div className="flex items-center space-x-3">
                                ...
                                <h4 className="font-bold text-gray-900 text-base">
                                    {index + 1}. {method.type === 'mobile_wallet' ? 'Mobile Wallet' : (method.type === 'paypal' ? 'PayPal' : 'Bank Transfer')}
                                </h4>
                            </div>
