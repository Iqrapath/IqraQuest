...
export default function TeacherProfileHeader({ teacher, earnings }: TeacherProfileHeaderProps) {
    return (
        <div className="relative w-full mb-8">
            ...
            <div className="w-full h-[200px] rounded-t-[24px] overflow-hidden">
                <img
            ...
            <div className="relative -mt-[100px] px-[48px] z-10">
                <div className="flex items-end justify-between gap-8">
                    {/* LEFT SIDE - Profile Info */}
                    <div className="flex flex-col gap-[16px] mb-4">
                        {/* Profile Photo */}
                        <div className="w-[147px] h-[147px] rounded-full overflow-hidden border-[6px] border-white shadow-xl bg-white">
                            {teacher.user.avatar ? (
                                <img
                                ...
                                <div className="w-full h-full bg-gradient-to-br from-[#338078] to-[#FFCC00] flex items-center justify-center">
                                    <span className="text-white font-bold text-[48px] font-['Nunito']">
                        ...
                        <div className="mt-2 text-center">
                            {/* Name */}
                            <h1 className="font-['Nunito'] font-semibold text-[32px] leading-[1.2] text-[#141522]">
                                {teacher.user.name}
                            </h1>

                            {/* Role */}
                            <p className="font-['Nunito'] text-[16px] leading-[1.2] text-gray-600 mt-1 uppercase">
                                {teacher.user.role}
                            </p>
                    ...
                    <div className="bg-white rounded-[20px] shadow-[0px_4px_16px_rgba(0,0,0,0.08)] p-[24px] min-w-[440px] mb-20">
                        {/* Card Title */}
                        <h2 className="font-['Nunito'] font-semibold text-[18px] text-[#141522] mb-[20px]">
                            Earnings
                        </h2>
                        ...
                        <div className="flex gap-[12px] mb-[16px]">
                            {/* Wallet Balance */}
                            <div className="flex-1 bg-[#E8F5FF] rounded-[12px] p-[16px]">
                                <div className="flex items-center gap-2 mb-1">
                                    <Icon icon="mdi:wallet-outline" className="w-5 h-5 text-[#338078]" />
                                    <p className="font-['Nunito'] font-bold text-[20px] text-[#141522]">
                            ...
                            {/* Pending Payouts */}
                            <div className="flex-1 bg-[#FFF8E8] rounded-[12px] p-[16px]">
                                <div className="flex items-center gap-2 mb-1">
                        ...
                        <div className="text-right">
                            <Link
                                ...
                                className="font-['Nunito'] font-medium text-[14px] text-[#338078] hover:underline transition-all inline-flex items-center gap-1"
                            >
