...
export default function StudentStepSection() {
    const steps = [
        {
            number: "01",
            title: "Browse & Choose a Teacher",
            description: "Find qualified Quran teachers worldwide based on your needs and budget.",
            icon: "ph:magnifying-glass-bold",
            iconBg: "#d4ccff",
            image: "/images/Frame 2147484138.png",
            align: "start"
        },
        {
            number: "02",
            title: "Book a Lesson",
            description: "Schedule flexible sessions at your convenience with your preferred teacher.",
            icon: "ph:calendar-plus-bold",
            iconBg: "#ccf2ff",
            image: "/images/Frame 2147484139.png",
            align: "center"
        },
        {
            number: "03",
            title: "Start Learning",
            description: "Learn Tajweed, Hifz, Islamic Studies, and more through interactive classes.",
            icon: "ph:book-open-bold",
            iconBg: "#ffccf2",
            image: "/images/Little-boy-listening-his-teacher-through-headphones 4.png",
            align: "end"
        }
    ];
        ...
        <section className="relative w-full overflow-hidden bg-white py-[clamp(4rem,10vw,8rem)] px-[clamp(1rem,11.81vw,10.625rem)]">
            ...
            <div className="absolute top-[10%] left-0 w-full h-full pointer-events-none -z-10 overflow-hidden">
                <img
                    ...
                    alt=""
                    className="absolute top-[20%] left-1/2 -translate-x-1/2 w-[clamp(400px,60vw,800px)] opacity-[0.03] rotate-[-15deg]"
                />
                <div className="absolute top-[40%] right-[-10%] w-[500px] h-[500px] bg-[#338078]/5 rounded-full blur-[120px]" />
                <div className="absolute bottom-0 left-[-10%] w-[400px] h-[400px] bg-[#ffeec7]/10 rounded-full blur-[100px]" />
            </div>
            ...
            <div className="relative mx-auto max-w-[1440px]">
                ...
                <div className="mb-[clamp(3rem,8vw,6rem)] text-center">
                    <h2
                        className="bg-gradient-to-r from-[#338078] to-[#ffeec7] bg-clip-text font-['Nunito'] text-[clamp(2.5rem,5vw,4.5rem)] font-bold leading-tight text-transparent drop-shadow-[0_20px_15px_rgba(0,0,0,0.05)]"
                    >
                        For Student
                    </h2>
                </div>
                ...
                <div className="relative flex flex-col gap-24 lg:gap-0 min-h-[clamp(600px,80vh,1100px)]">
                    ...
                    <svg className="absolute inset-0 w-full h-full hidden lg:block -z-10" preserveAspectRatio="none">
                        <path
                            d="M 200 250 C 400 250, 400 550, 720 550 C 1040 550, 1040 850, 1200 850"
                            fill="none"
                            stroke="#338078"
                            strokeWidth="2"
                            strokeDasharray="8 8"
                        ...
                        />
                        {/* Nodes */}
                        <circle cx="450" cy="400" r="6" fill="#338078" opacity="0.4" />
                        <circle cx="950" cy="700" r="6" fill="#338078" opacity="0.4" />
                    </svg>

                    {steps.map((step, idx) => (
                        <div
                            key={idx}
                            className={`flex flex-col lg:flex-row w-full ${step.align === 'start' ? 'justify-start lg:items-start' :
                                    step.align === 'center' ? 'justify-center lg:items-center -mt-16 lg:mt-[-50px]' :
                                        'justify-end lg:items-end -mt-16 lg:mt-[-50px]'
                                }`}
                        >
                ...
                <div className="mt-20 flex justify-center">
                    ...
                    >
                        ...
                        <Icon icon="ph:arrow-right-bold" className="size-5 transition-transform group-hover:translate-x-1" />
                    </Link>
                </div>
            </div>
        </section>
