    ...
    return (
        <div className="relative w-full overflow-hidden bg-white">
            ...
            <div className="relative bg-[#eeffe6]">
                <div className="flex items-center gap-[clamp(1rem,1.46vw,1.313rem)] px-[clamp(2rem,8.33vw,7.5rem)] py-[clamp(1.5rem,1.81vw,1.625rem)]">
                    {/* Image */}
                    <div className="relative h-[clamp(300px,34.72vw,500px)] w-[clamp(300px,34.72vw,500px)] shrink-0">
                        <img
                    ...
                    {/* Content */}
                    <div className="flex w-[clamp(400px,43.61vw,628px)] flex-col gap-[clamp(2rem,3.61vw,3.25rem)] px-[clamp(0.5rem,0.83vw,0.75rem)]">
                        ...
                        {/* Buttons */}
                        <div className="flex items-center gap-[clamp(0.5rem,0.56vw,0.5rem)]">
                            <Link
                                href="#memorization-plans"
                                className="rounded-full bg-[#338078] px-[20px] py-[10px] font-['Nunito'] text-[clamp(1rem,1.67vw,1.5rem)] font-semibold capitalize text-white transition-all hover:bg-[#2a6b64] hover:shadow-lg"
                            >
                            ...
                            <div className="flex items-center">
                                ...
                                <Link
                                    href="#match-me"
                                    className="rounded-full border-[1.5px] border-solid border-[#338078] px-[20px] py-[8px] font-['Nunito'] text-[clamp(1rem,1.67vw,1.5rem)] font-semibold capitalize text-[#338078] transition-all hover:bg-[#338078] hover:text-white"
                                >
                                    Match Me
                                </Link>
                            </div>
