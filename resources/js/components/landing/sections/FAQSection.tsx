...
function FAQItem({ number, question, answer, isOpen, onToggle }: FAQItemProps) {
    return (
        <div className="w-full">
            <div 
                className={`w-full rounded-[clamp(1rem,2.22vw,2rem)] border border-[rgba(51,128,120,0.3)] px-[clamp(1rem,3.88vw,3.493rem)] py-[clamp(1.5rem,3.36vw,3.027rem)] transition-all ${
                ...
                <div className="flex items-start gap-[clamp(1rem,3.36vw,3.027rem)]">
                    ...
                    <div className="flex flex-1 flex-col gap-[clamp(0.75rem,1.55vw,1.397rem)]">
                        ...
                        <div className="flex items-start justify-between gap-[clamp(0.5rem,1.03vw,0.931rem)]">
                            ...
                            <button
                                onClick={onToggle}
                                className={`flex size-[clamp(2rem,3.1vw,2.794rem)] shrink-0 items-center justify-center rounded-[clamp(0.5rem,1.67vw,1.5rem)] transition-colors ${
                            ...
                            >
                                <Icon 
                                    ...
                                    className={`h-[clamp(1rem,0.9vw,0.815rem)] w-[clamp(1rem,0.9vw,0.815rem)] ${
