...
Route::middleware(['auth', 'verified', 'role:admin'])
    ...
    ->group(function () {
        ...
        Route::prefix('bookings')->name('bookings.')->middleware(['can:manage_bookings'])->group(function () {
        ...
        Route::prefix('finances')->name('finances.')->middleware(['can:handle_payouts'])->group(function () {
            Route::get('/', [FinancialDashboardController::class, 'index'])->name('index');
        });

        // Transaction Routes
        Route::prefix('transactions')->name('transactions.')->middleware(['can:handle_payouts'])->group(function () {
        ...
        // Payout Routes
        Route::prefix('payouts')->name('payouts.')->middleware(['can:handle_payouts'])->group(function () {
        ...
        Route::prefix('teachers')->name('teachers.')->middleware(['can:manage_users'])->group(function () {
            // List/Index route
        ...
        Route::prefix('students')->name('students.')->middleware(['can:manage_users'])->group(function () {
        ...
        Route::prefix('payments')->name('payments.')->middleware(['can:handle_payouts'])->group(function () {
            Route::get('/', [\App\Http\Controllers\Admin\PaymentController::class, 'index'])->name('index');
            Route::put('/settings', [\App\Http\Controllers\Admin\PaymentController::class, 'updateSettings'])->name('update-settings');
            Route::get('/export', [\App\Http\Controllers\Admin\PaymentController::class, 'exportLogs'])->name('export');
        });

        // Dispute Management Routes
        Route::prefix('disputes')->name('disputes.')->middleware(['can:manage_bookings'])->group(function () {
        ...
        Route::prefix('settings')->name('settings.')->middleware(['can:change_platform_settings'])->group(function () {
            ...
            Route::post('/legal/update', [\App\Http\Controllers\Admin\SettingsController::class, 'updateLegal'])->name('legal.update');
        ...
        Route::prefix('faqs')->name('faqs.')->middleware(['can:change_platform_settings'])->group(function () {
        ...
        Route::prefix('verifications')->name('verifications.')->middleware(['can:manage_users'])->group(function () {
